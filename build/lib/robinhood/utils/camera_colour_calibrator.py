...
try:
    while True:
        ...
        #color_image  = cv2.resize(color_image , down_points, interpolation= cv2.INTER_LINEAR)
       ...
       # depth_colormap_dim = depth_colormap.shape
        ...
        if threadsArea>20:
            cv2.putText(color_image, "Not Capped!", (y-5, x-15),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
            cv2.rectangle(color_image, (y,x), (y+h,x+w), (0,0,255), 2)
        else:
            cv2.putText(color_image, "Capped!", (y+25, x-15),cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
            cv2.rectangle(color_image, (y,x), (y+h,x+w), (0,255,0), 2)
