...
SAMPLE_PAIRS2=("1 7" "2 8" "3 9" "4 10" "5 11" "6 12")
...
# python $LOCAL_PATH/dye_workflow.py "prime_lines"

# echo "[INFO] Reading robot state:"
# read_robot_state 

# echo "[INFO] Preparing samples in progress."
# python $LOCAL_PATH/dye_workflow.py "prepare_samples"

# echo "[INFO] Reading robot state:"
# read_robot_state

# echo "[INFO] Step 3: Stirring samples."
# python $LOCAL_PATH/dye_workflow.py "stirr_samples"

# echo "[INFO] Reading robot state:"
# read_robot_state

# echo "[INFO] Moving samples to rack."
# python $LOCAL_PATH/dye_workflow.py "store_samples"
...
python $LOCAL_PATH/dye_workflow.py "set_down" 
