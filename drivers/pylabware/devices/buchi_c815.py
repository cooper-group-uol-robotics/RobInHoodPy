...
from ..controllers import (
    AbstractFlashChromatographySystem,
    in_simulation_device_returns,
)
from ..exceptions import SLConnectionError, SLDeviceReplyError
...
class C815Commands(LabDeviceCommands):
    ...
    GET_PUMP_HARDWARE = {
        "name": "GET_PUMP_HARDWARE",
        "method": "GET",
        "endpoint": "/api/v1/Info",
        "path": ["pump", "hardware"],
        "reply": {"type": str},
    }
    GET_FRACTIONCOLLECTOR_FIRMWARE = {
        "name": "GET_FRACTIONCOLLECTOR_FIRMWARE",
        "method": "GET",
        "endpoint": "/api/v1/Info",
        "path": ["fractionCollector", "firmware"],
        "reply": {"type": str},
    }
    GET_FRACTIONCOLLECTOR_TRAYS = {
        "name": "GET_FRACTIONCOLLECTOR_TRAYS",
        "method": "GET",
        "endpoint": "/api/v1/Info",
        "path": ["fractionCollector", "trays"],
        "reply": {"type": list},
    }
    GET_COLUMN_VERSION = {
        "name": "GET_COLUMN_VERSION",
        "method": "GET",
        "endpoint": "/api/v1/Info",
        "path": ["column", "version"],
        "reply": {"type": str},
    }
    GET_COLUMN_COLUMNNAME = {
        "name": "GET_COLUMN_COLUMNNAME",
        "method": "GET",
        "endpoint": "/api/v1/Info",
    ...
    GET_SENSORS_SOLVENTPRESSUREAFTERPUMP = {
        "name": "GET_SENSORS_SOLVENTPRESSUREAFTERPUMP",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "solventPressureAfterPump"],
        "reply": {"type": float},
    }
    GET_SENSORS_SOLVENTPRESSUREAFTERCOLUMN = {
        "name": "GET_SENSORS_SOLVENTPRESSUREAFTERCOLUMN",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "solventPressureAfterColumn"],
        "reply": {"type": float},
    }
    GET_SENSORS_AIRPRESSURENEBULIZER = {
        "name": "GET_SENSORS_AIRPRESSURENEBULIZER",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "airPressureNebulizer"],
        "reply": {"type": float},
    }
    GET_SENSORS_AIRPRESSUREINLET = {
        "name": "GET_SENSORS_AIRPRESSUREINLET",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "airPressureInlet"],
        "reply": {"type": float},
    }
    GET_SENSORS_VAPORLEVEL = {
        "name": "GET_SENSORS_VAPORLEVEL",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "vaporLevel"],
        "reply": {"type": int},
    }
    GET_SENSORS_SOLVENTLEVELS = {
        "name": "GET_SENSORS_SOLVENTLEVELS",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "solventLevels"],
        "reply": {"type": list},
    }
    GET_SENSORS_WASTELEVEL = {
        "name": "GET_SENSORS_WASTELEVEL",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["sensors", "wasteLevel"],
        "reply": {"type": float},
    }
    GET_AIRSYSTEM_ISENABLED = {
        "name": "GET_AIRSYSTEM_ISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["airSystem", "isEnabled"],
        "reply": {"type": bool},
    }
    GET_AIRSYSTEM_VALVEPOS = {
        "name": "GET_AIRSYSTEM_VALVEPOS",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["airSystem", "valvePos"],
        "reply": {"type": str},
    }
    GET_ELSDDETECTOR_LASERISENABLED = {
        "name": "GET_ELSDDETECTOR_LASERISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "laserIsEnabled"],
        "reply": {"type": bool},
    }
    GET_ELSDDETECTOR_LASERVOLTAGE = {
        "name": "GET_ELSDDETECTOR_LASERVOLTAGE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "laserVoltage"],
        "reply": {"type": float},
    }
    GET_ELSDDETECTOR_SHUTTLEVALVEISENABLED = {
        "name": "GET_ELSDDETECTOR_SHUTTLEVALVEISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "shuttleValveIsEnabled"],
        "reply": {"type": bool},
    }
    GET_ELSDDETECTOR_CARRIERFLOWISENABLED = {
        "name": "GET_ELSDDETECTOR_CARRIERFLOWISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "carrierFlowIsEnabled"],
        "reply": {"type": bool},
    }
    GET_ELSDDETECTOR_SENSITIVITY = {
        "name": "GET_ELSDDETECTOR_SENSITIVITY",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "sensitivity"],
        "reply": {"type": str},
    }
    GET_ELSDDETECTOR_SIGNAL_TIMESINCESTART = {
        "name": "GET_ELSDDETECTOR_SIGNAL_TIMESINCESTART",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "signal", "timeSinceStart"],
        "reply": {"type": str},
    }
    GET_ELSDDETECTOR_SIGNAL_SIGNAL = {
        "name": "GET_ELSDDETECTOR_SIGNAL_SIGNAL",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["elsdDetector", "signal", "signal"],
        "reply": {"type": float},
    }
    GET_FRACTIONCOLLECTOR_POSITION_TRAY = {
        "name": "GET_FRACTIONCOLLECTOR_POSITION_TRAY",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["fractionCollector", "position", "tray"],
        "reply": {"type": str},
    }
    GET_FRACTIONCOLLECTOR_POSITION_VIAL = {
        "name": "GET_FRACTIONCOLLECTOR_POSITION_VIAL",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["fractionCollector", "position", "vial"],
        "reply": {"type": str},
    }
    GET_FRACTIONCOLLECTOR_COLLECTIONTASK_ACTION = {
        "name": "GET_FRACTIONCOLLECTOR_COLLECTIONTASK_ACTION",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["fractionCollector", "collectionTask", "action"],
        "reply": {"type": str},
    }
    GET_SOLVENTSYSTEM_FLOWISENABLED = {
        "name": "GET_SOLVENTSYSTEM_FLOWISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "flowIsEnabled"],
        "reply": {"type": bool},
    }
    GET_SOLVENTSYSTEM_FLOWRATE = {
        "name": "GET_SOLVENTSYSTEM_FLOWRATE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "flowRate"],
        "reply": {"type": int},
    }
    GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE1PERCENTAGE = {
        "name": "GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE1PERCENTAGE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "solventMixture", "line1Percentage"],
        "reply": {"type": float},
    }
    GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE2PERCENTAGE = {
        "name": "GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE2PERCENTAGE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "solventMixture", "line2Percentage"],
        "reply": {"type": float},
    }
    GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE3PERCENTAGE = {
        "name": "GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE3PERCENTAGE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "solventMixture", "line3Percentage"],
        "reply": {"type": float},
    }
    GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE4PERCENTAGE = {
        "name": "GET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE4PERCENTAGE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "solventMixture", "line4Percentage"],
        "reply": {"type": float},
    }
    GET_SOLVENTSYSTEM_SAMPLEINJECTIONVALVEPOS = {
        "name": "GET_SOLVENTSYSTEM_SAMPLEINJECTIONVALVEPOS",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "sampleInjectionValvePos"],
        "reply": {"type": str},
    }
    GET_SOLVENTSYSTEM_MODE = {
        "name": "GET_SOLVENTSYSTEM_MODE",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["solventSystem", "mode"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ABSORBANCE_TIMESINCESTART = {
        "name": "GET_UVDETECTOR_ABSORBANCE_TIMESINCESTART",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "timeSinceStart"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ABSORBANCE_CH1 = {
        "name": "GET_UVDETECTOR_ABSORBANCE_CH1",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "ch1"],
        "reply": {"type": float},
    }
    GET_UVDETECTOR_ABSORBANCE_CH2 = {
        "name": "GET_UVDETECTOR_ABSORBANCE_CH2",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "ch2"],
        "reply": {"type": float},
    }
    GET_UVDETECTOR_ABSORBANCE_CH3 = {
        "name": "GET_UVDETECTOR_ABSORBANCE_CH3",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "ch3"],
        "reply": {"type": float},
    }
    GET_UVDETECTOR_ABSORBANCE_CH4 = {
        "name": "GET_UVDETECTOR_ABSORBANCE_CH4",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "ch4"],
        "reply": {"type": float},
    }
    GET_UVDETECTOR_ABSORBANCE_SCAN = {
        "name": "GET_UVDETECTOR_ABSORBANCE_SCAN",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "absorbance", "scan"],
        "reply": {"type": float},
    }
    GET_UVDETECTOR_WAVELENGTHS_CH1 = {
        "name": "GET_UVDETECTOR_WAVELENGTHS_CH1",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "ch1"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_WAVELENGTHS_CH2 = {
        "name": "GET_UVDETECTOR_WAVELENGTHS_CH2",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "ch2"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_WAVELENGTHS_CH3 = {
        "name": "GET_UVDETECTOR_WAVELENGTHS_CH3",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "ch3"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_WAVELENGTHS_CH4 = {
        ...
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "ch4"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_WAVELENGTHS_SCANSTART = {
        "name": "GET_UVDETECTOR_WAVELENGTHS_SCANSTART",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "scanStart"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_WAVELENGTHS_SCANEND = {
        "name": "GET_UVDETECTOR_WAVELENGTHS_SCANEND",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "wavelengths", "scanEnd"],
        "reply": {"type": int},
    }
    GET_UVDETECTOR_ENABLEDCHANNELS_CH1 = {
        "name": "GET_UVDETECTOR_ENABLEDCHANNELS_CH1",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "enabledChannels", "ch1"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ENABLEDCHANNELS_CH2 = {
        "name": "GET_UVDETECTOR_ENABLEDCHANNELS_CH2",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "enabledChannels", "ch2"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ENABLEDCHANNELS_CH3 = {
        "name": "GET_UVDETECTOR_ENABLEDCHANNELS_CH3",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "enabledChannels", "ch3"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ENABLEDCHANNELS_CH4 = {
        "name": "GET_UVDETECTOR_ENABLEDCHANNELS_CH4",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "enabledChannels", "ch4"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_ENABLEDCHANNELS_SCAN = {
        "name": "GET_UVDETECTOR_ENABLEDCHANNELS_SCAN",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "enabledChannels", "scan"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_SENSITIVITY = {
        "name": "GET_UVDETECTOR_SENSITIVITY",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "sensitivity"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_SPECTRUM_TIMESINCESTART = {
        "name": "GET_UVDETECTOR_SPECTRUM_TIMESINCESTART",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "spectrum", "timeSinceStart"],
        "reply": {"type": str},
    }
    GET_UVDETECTOR_SPECTRUM_VALUES = {
        "name": "GET_UVDETECTOR_SPECTRUM_VALUES",
        "method": "GET",
        "endpoint": "/api/v1/Process",
        "path": ["uvDetector", "spectrum", "values"],
        "reply": {"type": list},
    }
    SET_RUNMODE = {
        "name": "SET_RUNMODE",
        ...
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Flash", "Prep"]},
        "path": ["runMode"],
    }
    SET_AIRSYSTEM_ISENABLED = {
        "name": "SET_AIRSYSTEM_ISENABLED",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": bool,
        "check": None,
    ...
    SET_AIRSYSTEM_VALVEPOS = {
        "name": "SET_AIRSYSTEM_VALVEPOS",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "Elsd", "Column"]},
        "path": ["airSystem", "valvePos"],
    }
    SET_ELSDDETECTOR_LASERISENABLED = {
        "name": "SET_ELSDDETECTOR_LASERISENABLED",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": bool,
        "check": None,
    ...
    SET_ELSDDETECTOR_CARRIERFLOWISENABLED = {
        "name": "SET_ELSDDETECTOR_CARRIERFLOWISENABLED",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": bool,
        "check": None,
    ...
    SET_ELSDDETECTOR_SENSITIVITY = {
        "name": "SET_ELSDDETECTOR_SENSITIVITY",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Low", "High"]},
        "path": ["elsdDetector", "sensitivity"],
    }
    SET_FRACTIONCOLLECTOR_POSITION_TRAY = {
        "name": "SET_FRACTIONCOLLECTOR_POSITION_TRAY",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Left", "Right", "Unknown"]},
        "path": ["fractionCollector", "position", "tray"],
    }
    SET_FRACTIONCOLLECTOR_POSITION_VIAL = {
        "name": "SET_FRACTIONCOLLECTOR_POSITION_VIAL",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Unknown", "Home"]},
        "path": ["fractionCollector", "position", "vial"],
    }
    SET_FRACTIONCOLLECTOR_COLLECTIONTASK_ACTION = {
        "name": "SET_FRACTIONCOLLECTOR_COLLECTIONTASK_ACTION",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Waste", "Vial"]},
        "path": ["fractionCollector", "collectionTask", "action"],
    }
    SET_SOLVENTSYSTEM_FLOWISENABLED = {
        "name": "SET_SOLVENTSYSTEM_FLOWISENABLED",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": bool,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_FLOWRATE = {
        "name": "SET_SOLVENTSYSTEM_FLOWRATE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE1PERCENTAGE = {
        "name": "SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE1PERCENTAGE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": float,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE2PERCENTAGE = {
        "name": "SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE2PERCENTAGE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": float,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE3PERCENTAGE = {
        "name": "SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE3PERCENTAGE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": float,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE4PERCENTAGE = {
        "name": "SET_SOLVENTSYSTEM_SOLVENTMIXTURE_LINE4PERCENTAGE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": float,
        "check": None,
    ...
    SET_SOLVENTSYSTEM_SAMPLEINJECTIONVALVEPOS = {
        "name": "SET_SOLVENTSYSTEM_SAMPLEINJECTIONVALVEPOS",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Load", "Separation"]},
        "path": ["solventSystem", "sampleInjectionValvePos"],
    }
    SET_SOLVENTSYSTEM_MODE = {
        "name": "SET_SOLVENTSYSTEM_MODE",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Flash", "Prep"]},
    ...
    SET_UVDETECTOR_WAVELENGTHS_CH1 = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_CH1",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_WAVELENGTHS_CH2 = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_CH2",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_WAVELENGTHS_CH3 = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_CH3",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_WAVELENGTHS_CH4 = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_CH4",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_WAVELENGTHS_SCANSTART = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_SCANSTART",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_WAVELENGTHS_SCANEND = {
        "name": "SET_UVDETECTOR_WAVELENGTHS_SCANEND",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": int,
        "check": None,
    ...
    SET_UVDETECTOR_ENABLEDCHANNELS_CH1 = {
        "name": "SET_UVDETECTOR_ENABLEDCHANNELS_CH1",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "On", "Monitor"]},
        "path": ["uvDetector", "enabledChannels", "ch1"],
    }
    SET_UVDETECTOR_ENABLEDCHANNELS_CH2 = {
        "name": "SET_UVDETECTOR_ENABLEDCHANNELS_CH2",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "On", "Monitor"]},
    ...
    SET_UVDETECTOR_ENABLEDCHANNELS_CH3 = {
        "name": "SET_UVDETECTOR_ENABLEDCHANNELS_CH3",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "On", "Monitor"]},
    ...
    SET_UVDETECTOR_ENABLEDCHANNELS_CH4 = {
        "name": "SET_UVDETECTOR_ENABLEDCHANNELS_CH4",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "On", "Monitor"]},
    ...
    SET_UVDETECTOR_ENABLEDCHANNELS_SCAN = {
        "name": "SET_UVDETECTOR_ENABLEDCHANNELS_SCAN",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Off", "On", "Monitor"]},
    ...
    SET_UVDETECTOR_SENSITIVITY = {
        "name": "SET_UVDETECTOR_SENSITIVITY",
        "method": "PUT",
        "endpoint": "/api/v1/Process",
        "type": str,
        "check": {"values": ["Low", "High"]},
    ...
    def parse_reply(self, cmd: Dict, reply: LabDeviceReply) -> Any:
        ...
        if reply.content_type != "json":
            raise SLDeviceReplyError(
                f"Invalid content-type {reply.content_type} in device reply!"
            )
        try:
            reply = json.loads(reply.body)
        except (json.JSONDecodeError, TypeError) as e:
            raise SLDeviceReplyError("Can't transform device reply to JSON!") from e
