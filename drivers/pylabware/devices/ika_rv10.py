...
class RV10RotovapCommands(LabDeviceCommands):
    ...
    GET_NAME = {
        "name": "IN_NAME",
        "reply": {"type": str, "parser": parser.slicer, "args": [None, 11]},
    }
    ...
    GET_SPEED = {
        "name": "IN_PV_4",
        "reply": {"type": int, "parser": parser.slicer, "args": [None, -2]},
    }
    ...
    GET_TEMP = {
        "name": "IN_PV_2",
        "reply": {"type": float, "parser": parser.slicer, "args": [None, -2]},
    }
...
class RV10Rotovap(AbstractRotavap):
    ...
    def initialize_device(self):
        ...
        # This is legacy initialization from SL1
