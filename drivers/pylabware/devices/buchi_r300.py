...
from ..exceptions import SLDeviceCommandError, SLDeviceReplyError
...
class R300RotovapCommands(LabDeviceCommands):
    ...
    GET_HEATING_RUNNING = {
        "name": "GET_HEATING_RUNNING",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["heating", "running"],
        "reply": {"type": bool},
    }
    GET_COOLING_SET = {
        "name": "GET_COOLING_SET",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["cooling", "set"],
        "reply": {"type": float},
    ...
    GET_COOLING_RUNNING = {
        "name": "GET_COOLING_RUNNING",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["cooling", "running"],
        "reply": {"type": bool},
    }
    GET_VACUUM_SET = {
        "name": "GET_VACUUM_SET",
    ...
    GET_VACUUM_AERATEVALVEOPEN = {
        "name": "GET_VACUUM_AERATEVALVEOPEN",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "aerateValveOpen"],
        "reply": {"type": bool},
    }
    GET_VACUUM_AERATEVALVEPULSE = {
        "name": "GET_VACUUM_AERATEVALVEPULSE",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "aerateValvePulse"],
        "reply": {"type": bool},
    }
    GET_VACUUM_VACUUMVALVEOPEN = {
        "name": "GET_VACUUM_VACUUMVALVEOPEN",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "vacuumValveOpen"],
        "reply": {"type": bool},
    }
    GET_VACUUM_VAPORTEMP = {
        "name": "GET_VACUUM_VAPORTEMP",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "vaporTemp"],
        "reply": {"type": float},
    }
    GET_VACUUM_AUTODESTIN = {
        "name": "GET_VACUUM_AUTODESTIN",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "autoDestIn"],
        "reply": {"type": float},
    }
    GET_VACUUM_AUTODESTOUT = {
        "name": "GET_VACUUM_AUTODESTOUT",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "autoDestOut"],
        "reply": {"type": float},
    }
    GET_VACUUM_POWERPERCENTACT = {
        "name": "GET_VACUUM_POWERPERCENTACT",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["vacuum", "powerPercentAct"],
        "reply": {"type": int},
    }
    GET_ROTATION_SET = {
        "name": "GET_ROTATION_SET",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["rotation", "set"],
        "reply": {"type": float},
    ...
    GET_ROTATION_ACT = {
        "name": "GET_ROTATION_ACT",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["rotation", "act"],
        "reply": {"type": float},
    }
    GET_ROTATION_RUNNING = {
        "name": "GET_ROTATION_RUNNING",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["rotation", "running"],
        "reply": {"type": bool},
    }
    GET_LIFT_SET = {
        "name": "GET_LIFT_SET",
    ...
    GET_GLOBALSTATUS_TIMESTAMP = {
        "name": "GET_GLOBALSTATUS_TIMESTAMP",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "timeStamp"],
        "reply": {"type": str},
    }
    GET_GLOBALSTATUS_PROCESSTIME = {
        "name": "GET_GLOBALSTATUS_PROCESSTIME",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "processTime"],
        "reply": {"type": int},
    }
    GET_GLOBALSTATUS_RUNID = {
        "name": "GET_GLOBALSTATUS_RUNID",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "runId"],
        "reply": {"type": int},
    }
    GET_GLOBALSTATUS_ONHOLD = {
        "name": "GET_GLOBALSTATUS_ONHOLD",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "onHold"],
        "reply": {"type": bool},
    }
    GET_GLOBALSTATUS_FOAMACTIVE = {
        "name": "GET_GLOBALSTATUS_FOAMACTIVE",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "foamActive"],
        "reply": {"type": bool},
    }
    GET_GLOBALSTATUS_CURRENTERROR = {
        "name": "GET_GLOBALSTATUS_CURRENTERROR",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "currentError"],
        "reply": {"type": int},
    }
    GET_GLOBALSTATUS_RUNNING = {
        "name": "GET_GLOBALSTATUS_RUNNING",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["globalStatus", "running"],
        "reply": {"type": bool},
    }
    GET_MODE = {
        "name": "GET_MODE",
    ...
    GET_SOLVENT_NAME = {
        "name": "GET_SOLVENT_NAME",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["program", "solventName"],
        "reply": {"type": str},
    }
    GET_METHOD_NAME = {
        ...
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["program", "methodName"],
        "reply": {"type": str},
    }
    GET_TIMER_REMAINING_TIME = {
        "name": "GET_TIMER_REMAINING_TIME",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["program", "remaining"],
        "reply": {"type": int},
    }
    GET_CLOUDDEST_MODE = {
        "name": "GET_CLOUDDEST_MODE",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["program", "mode"],
        "reply": {"type": str},
    }
    GET_CLOUDDEST_FLASK_SIZE = {
        "name": "GET_CLOUDDEST_FLASK_SIZE",
        "method": "GET",
        "endpoint": "/api/v1/process",
        "path": ["program", "flaskSize"],
        "reply": {"type": int},
    }
    SET_HEATING_SET = {
        "name": "SET_HEATING_SET",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": float,
        "check": {"min": 0, "max": 220},
    ...
    SET_VACUUM_SET = {
        ...
        "endpoint": "/api/v1/process",
        "type": float,
        "check": {"min": 0, "max": 1300},
        "path": ["vacuum", "set"],
    }
    SET_VACUUM_AERATEVALVEOPEN = {
        "name": "SET_VACUUM_AERATEVALVEOPEN",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": bool,
        "check": None,
    ...
    SET_VACUUM_AERATEVALVEPULSE = {
        "name": "SET_VACUUM_AERATEVALVEPULSE",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": bool,
        "check": None,
    ...
    SET_ROTATION_RUNNING = {
        "name": "SET_ROTATION_RUNNING",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": bool,
        "check": None,
    ...
    SET_GLOBALSTATUS_ONHOLD = {
        "name": "SET_GLOBALSTATUS_ONHOLD",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": bool,
        "check": None,
    ...
    SET_GLOBALSTATUS_RUNNING = {
        "name": "SET_GLOBALSTATUS_RUNNING",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": bool,
        "check": None,
    ...
    SET_TIMER_TIME = {
        ...
        "endpoint": "/api/v1/process",
        "type": int,
        "check": {"min": 0, "max": 65520},
        "path": ["program", "set"],
    }
    SET_SOLVENT_NAME = {
        "name": "SET_SOLVENT_NAME",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": str,
        "path": ["program", "solventName"],
    ...
    SET_CLOUDDEST_MODE = {
        "name": "SET_CLOUDDEST_MODE",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": str,
        "check": {"values": ["fullControl", "endDetection"]},
        "path": ["program", "mode"],
    }
    SET_CLOUDDEST_FLASK_SIZE = {
        "name": "SET_CLOUDDEST_FLASK_SIZE",
        "method": "PUT",
        "endpoint": "/api/v1/process",
        "type": int,
        "check": {"values": [1, 2, 3]},
    ...
    GET_NETWORK_CLOUDIP = {
        "name": "GET_NETWORK_CLOUDIP",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["network", "cloudIp"],
        "reply": {"type": str},
    }
    GET_NETWORK_CLOUDENABLED = {
        "name": "GET_NETWORK_CLOUDENABLED",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["network", "cloudEnabled"],
        "reply": {"type": bool},
    }
    GET_DISPLAY_LANGUAGE = {
        "name": "GET_DISPLAY_LANGUAGE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
    ...
    GET_DISPLAY_UNITS_TEMPERATURE = {
        "name": "GET_DISPLAY_UNITS_TEMPERATURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["display", "units", "temperature"],
        "reply": {"type": str},
    }
    GET_DISPLAY_UNITS_PRESSURE = {
        "name": "GET_DISPLAY_UNITS_PRESSURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["display", "units", "pressure"],
        "reply": {"type": str},
    }
    GET_SOUNDS_BUTTONTONE = {
        "name": "GET_SOUNDS_BUTTONTONE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["sounds", "buttonTone"],
        "reply": {"type": bool},
    }
    GET_SOUNDS_PLAYSOUNDONFINISH = {
        "name": "GET_SOUNDS_PLAYSOUNDONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["sounds", "playSoundOnFinish"],
        "reply": {"type": bool},
    }
    GET_VACUUM_PRESSUREHYSTERESIS = {
        "name": "GET_VACUUM_PRESSUREHYSTERESIS",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["vacuum", "pressureHysteresis"],
        "reply": {"type": float},
    }
    GET_VACUUM_ALTITUDE = {
        "name": "GET_VACUUM_ALTITUDE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["vacuum", "altitude"],
        "reply": {"type": float},
    }
    GET_VACUUM_MAXPERMPRESSURE = {
        "name": "GET_VACUUM_MAXPERMPRESSURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["vacuum", "maxPermPressure"],
        "reply": {"type": float},
    }
    GET_VACUUM_MAXPUMPOUTPUT = {
        "name": "GET_VACUUM_MAXPUMPOUTPUT",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["vacuum", "maxPumpOutput"],
        "reply": {"type": int},
    }
    GET_VACUUM_VENTONFINISH = {
        "name": "GET_VACUUM_VENTONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["vacuum", "ventOnFinish"],
        "reply": {"type": bool},
    }
    GET_ROTATION_STARTROTATIONONSTART = {
        "name": "GET_ROTATION_STARTROTATIONONSTART",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["rotation", "startRotationOnStart"],
        "reply": {"type": bool},
    }
    GET_ROTATION_STOPROTATIONONFINISH = {
        "name": "GET_ROTATION_STOPROTATIONONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["rotation", "stopRotationOnFinish"],
        "reply": {"type": bool},
    }
    GET_HEATING_MAXTEMPERATURE = {
        "name": "GET_HEATING_MAXTEMPERATURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["heating", "maxTemperature"],
        "reply": {"type": float},
    }
    GET_HEATING_STOPHEATINGONFINISH = {
        "name": "GET_HEATING_STOPHEATINGONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["heating", "stopHeatingOnFinish"],
        "reply": {"type": bool},
    }
    GET_COOLING_STOPCOOLINGONFINISH = {
        "name": "GET_COOLING_STOPCOOLINGONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["cooling", "stopCoolingOnFinish"],
        "reply": {"type": bool},
    }
    GET_LIFT_DEPTHSTOP = {
        "name": "GET_LIFT_DEPTHSTOP",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["lift", "depthStop"],
        "reply": {"type": float},
    }
    GET_LIFT_IMMERSEONSTART = {
        "name": "GET_LIFT_IMMERSEONSTART",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["lift", "immerseOnStart"],
        "reply": {"type": bool},
    }
    GET_LIFT_LIFTOUTFLASKONFINISH = {
        "name": "GET_LIFT_LIFTOUTFLASKONFINISH",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["lift", "liftOutFlaskOnFinish"],
        "reply": {"type": bool},
    }
    GET_PROGRAM_ECO_ISENABLED = {
        "name": "GET_PROGRAM_ECO_ISENABLED",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["program", "eco", "isEnabled"],
        "reply": {"type": bool},
    }
    GET_PROGRAM_ECO_ACTIVATIONAFTERMINS = {
        "name": "GET_PROGRAM_ECO_ACTIVATIONAFTERMINS",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["program", "eco", "activationAfterMins"],
        "reply": {"type": int},
    }
    GET_PROGRAM_ECO_HEATINGBATHTEMPERATURE = {
        "name": "GET_PROGRAM_ECO_HEATINGBATHTEMPERATURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["program", "eco", "heatingBathTemperature"],
        "reply": {"type": float},
    }
    GET_PROGRAM_ECO_COOLANTTEMPERATURE = {
        "name": "GET_PROGRAM_ECO_COOLANTTEMPERATURE",
        "method": "GET",
        "endpoint": "/api/v1/settings",
        "path": ["program", "eco", "coolantTemperature"],
        "reply": {"type": float},
    }
    SET_DISPLAY_LANGUAGE = {
        ...
        "type": str,
        "check": {
            "values": ["en", "de", "fr", "it", "es", "ru", "pt", "ja", "zh", "ko", "id"]
        },
        "path": ["display", "language"],
    }
    ...
    SET_DISPLAY_UNITS_TEMPERATURE = {
        "name": "SET_DISPLAY_UNITS_TEMPERATURE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": str,
        "check": {"values": ["Celsius", "Fahrenheit", "Kelvin"]},
        "path": ["display", "units", "temperature"],
    }
    SET_DISPLAY_UNITS_PRESSURE = {
        "name": "SET_DISPLAY_UNITS_PRESSURE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": str,
        "check": {"values": ["hPa", "mBar", "torr", "mmhg"]},
        "path": ["display", "units", "pressure"],
    }
    SET_SOUNDS_BUTTONTONE = {
        "name": "SET_SOUNDS_BUTTONTONE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_SOUNDS_PLAYSOUNDONFINISH = {
        "name": "SET_SOUNDS_PLAYSOUNDONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_VACUUM_PRESSUREHYSTERESIS = {
        "name": "SET_VACUUM_PRESSUREHYSTERESIS",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": float,
        "check": {"min": 0, "max": 200},
    ...
    SET_VACUUM_ALTITUDE = {
        "name": "SET_VACUUM_ALTITUDE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": float,
        "check": {"min": 0, "max": 4000},
        "path": ["vacuum", "altitude"],
    }
    SET_VACUUM_MAXPERMPRESSURE = {
        "name": "SET_VACUUM_MAXPERMPRESSURE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": float,
        "check": {"min": 0, "max": 1300},
    ...
    SET_VACUUM_VENTONFINISH = {
        "name": "SET_VACUUM_VENTONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_ROTATION_STARTROTATIONONSTART = {
        "name": "SET_ROTATION_STARTROTATIONONSTART",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_ROTATION_STOPROTATIONONFINISH = {
        "name": "SET_ROTATION_STOPROTATIONONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_HEATING_STOPHEATINGONFINISH = {
        "name": "SET_HEATING_STOPHEATINGONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_COOLING_STOPCOOLINGONFINISH = {
        "name": "SET_COOLING_STOPCOOLINGONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_LIFT_IMMERSEONSTART = {
        "name": "SET_LIFT_IMMERSEONSTART",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_LIFT_LIFTOUTFLASKONFINISH = {
        "name": "SET_LIFT_LIFTOUTFLASKONFINISH",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_PROGRAM_ECO_ISENABLED = {
        "name": "SET_PROGRAM_ECO_ISENABLED",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": bool,
        "check": None,
    ...
    SET_PROGRAM_ECO_ACTIVATIONAFTERMINS = {
        "name": "SET_PROGRAM_ECO_ACTIVATIONAFTERMINS",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": int,
        "check": {"min": 5, "max": 100},
    ...
    SET_PROGRAM_ECO_HEATINGBATHTEMPERATURE = {
        "name": "SET_PROGRAM_ECO_HEATINGBATHTEMPERATURE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": float,
        "check": {"min": 3, "max": 200},
    ...
    SET_PROGRAM_ECO_COOLANTTEMPERATURE = {
        "name": "SET_PROGRAM_ECO_COOLANTTEMPERATURE",
        "method": "PUT",
        "endpoint": "/api/v1/settings",
        "type": float,
        "check": {"min": 3, "max": 50},
...
class R300Rotovap(AbstractRotavap, AbstractPressureController):
    ...
    def parse_reply(self, cmd: dict, reply: LabDeviceReply) -> Any:
        ...
        try:
            reply = json.loads(re.sub(r"\bnan\b", "NaN", reply.body))
    ...
    def initialize_device(self) -> None:
        """Initialize device"""
        # TODO Add something to initialize device

    def setup_device_with_default_settings(self) -> None:
    ...
    def set_timer_time(self, time: int) -> None:
        ...
        if current_mode != "Timer":
            self.set_mode("Timer")
            self.logger.info(f"Switching program from '{current_mode}' to " "'Timer'.")

        return self.send(self.cmd.SET_TIMER_TIME, time)

    def get_timer_set_time(self) -> int | None:
        ...
        if current_mode != "Timer":
            self.logger.warning(
                "Can't retreive set time of the 'Timer' program "
    ...
    def get_timer_remaining_time(self) -> int | None:
        ...
        if current_mode != "Timer":
            self.logger.warning(
                "Can't retreive remaining time of the 'Timer' "
    ...
    def set_solvent_name(self, solvent: str) -> None:
        ...
        Exceptions:
            raises SLDeviceCommandError if an unknonw solvent is selected.
        """
        current_mode = self.get_mode()
        ...
        if current_mode != "Solvent":
            ...
            self.logger.info(
                f"Switching program from '{current_mode}' to " "'Solvent'."
            )
        ...
        if self.get_solvent_name() != solvent:
            raise SLDeviceCommandError(
                f"The solvent name '{solvent}' was not recognised. "
    ...
    def get_solvent_name(self) -> str | None:
        ...
        if current_mode != "Solvent":
            self.logger.warning(
                "Can't retreive selected solvent of the 'Solvent' "
                "program since this program is not currently "
                f"selected (selected program is '{current_mode}'). "
    ...
    def set_method_name(self, method: str) -> None:
        ...
        Exceptions:
            raises SLDeviceCommandError if an unknonw method is selected.
        """
        current_mode = self.get_mode()
        # Defining the time for the Solvent program only has an effect
        # when first the Timer program is selected.
        if current_mode != "Method":
            ...
            self.logger.info(f"Switching program from '{current_mode}' to " "'Method'.")
        ...
        if self.get_method_name() != method:
            raise SLDeviceCommandError(
                f"The method name '{method}' was not recognised. "
    ...
    def get_method_name(self) -> str | None:
        ...
        if current_mode != "Method":
            self.logger.warning(
                "Can't retreive selected method of the 'Method' "
                "program since this program is not currently "
                f"selected (selected program is '{current_mode}'). "
    ...
    def set_clouddest_mode(self, mode: str) -> None:
        ...
        if current_mode != "CloudDest":
            ...
            self.logger.info(
                f"Switching program from '{current_mode}' to " "'CloudDest'."
            )

        self.send(self.cmd.SET_CLOUDDEST_MODE, mode)

    def get_clouddest_mode(self) -> str | None:
        ...
        if current_mode != "CloudDest":
            self.logger.warning(
                "Can't retreive selected method of the 'CloudDest' "
                "program since this program is not currently "
                f"selected (selected program is '{current_mode}'). "
    ...
    def get_clouddest_flask_size(self) -> int | None:
    ...
    def set_lift_pos(self, position):
        ...
        # BUG
        self.logger.warning(
            "Setting arbitrary lift position doesn't work in the current version of API"
        )
